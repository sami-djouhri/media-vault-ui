...
The private repo has the real mount paths in it, plus the compose files for the
media containers and the reverse-proxy configuration. None of that is here.
